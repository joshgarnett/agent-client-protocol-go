...
// Hint about the nature of this permission option.
type PermissionOptionKind interface{}

// The type of permission option being presented to the user.
//
// Helps clients choose appropriate icons and UI treatment.
type PermissionOptionKind_1 interface{}

// An execution plan for accomplishing complex tasks.
//
// Plans consist of multiple entries representing individual tasks or goals.
// Agents report plans to clients to provide visibility into their execution
// strategy.
// Plans can evolve during execution as the agent discovers new requirements or
// completes tasks.
//
// See protocol docs: [Agent
...
// The relative importance of this task.
// Used to indicate which tasks are most critical to the overall goal.
type PlanEntryPriority interface{}
...
// See protocol docs: [Plan
// Entries](https://agentclientprotocol.com/protocol/agent-plan#plan-entries)
type PlanEntryPriority_1 interface{}

// Current execution status of this task.
type PlanEntryStatus interface{}
...
// See protocol docs: [Plan
// Entries](https://agentclientprotocol.com/protocol/agent-plan#plan-entries)
type PlanEntryStatus_1 interface{}
...
//
// See protocol docs: [Tool
// Calls](https://agentclientprotocol.com/protocol/tool-calls)
...
type ToolCallStatus_1 interface{}
