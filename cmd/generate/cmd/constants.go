...
func doGenerateConstants() error {
	...
	output.WriteString("package acp\n\n")
	...
	// Write to file.
	outputFile, err := os.Create("acp/constants_generated.go")
	if err != nil {
	...
	fmt.Fprintf(os.Stdout, "Constants generated successfully in acp/constants_generated.go\n")
	return nil
}
